...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ThreadedComment.is_private_thread'
        db.add_column('threadedcomments_comment', 'is_private_thread',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ThreadedComment.is_private_thread'
        db.delete_column('threadedcomments_comment', 'is_private_thread')
    ...
    models = {
        ...
        u'threadedcomments.threadedcomment': {
            ...
            'is_private_thread': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
