...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ThreadedComment', fields ['is_public']
        db.create_index('threadedcomments_comment', ['is_public'])

        # Adding index on 'ThreadedComment', fields ['is_private_thread']
        db.create_index('threadedcomments_comment', ['is_private_thread'])


    def backwards(self, orm):
        # Removing index on 'ThreadedComment', fields ['is_private_thread']
        db.delete_index('threadedcomments_comment', ['is_private_thread'])

        # Removing index on 'ThreadedComment', fields ['is_public']
        db.delete_index('threadedcomments_comment', ['is_public'])
    ...
    models = {
        ...
        u'threadedcomments.threadedcomment': {
            ...
            'is_private_thread': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
        ...
        u'tweentribune.classroom': {
            ...
            'grade': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'tweentribune.teacher': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['sites.Site']"}),
            'state': ('smithsonian.apps.tweentribune.models.OptionalUSStateField', [], {'max_length': '2', 'null': 'True'}),
