...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('threadedcomments_comment', (
            ...
            ('tree_path', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ...
            ('classroom', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='comments', null=True, to=orm['tweentribune.Classroom'])),
